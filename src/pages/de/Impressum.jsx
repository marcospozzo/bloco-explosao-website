                ...
                <div className="row">
                  <div className="col-12">
                    <section className="box">
                      ...
                      <p>4. PLUGINS UND EINGEBETTETE INHALTE</p>
                      <p>
                        GOOGLE WEB FONTS<br />
                        ...
                        einheitlichen und ansprechenden Darstellung unserer Online-Angebote (Art. 6 Abs. 1 lit. f
                        DSGVO). Weitere Informationen: https://www.google.com/policies/privacy/.
                      </p>
                      <p>
                        YOUTUBE<br />
                        Wir nutzen für die Einbindung von Videos den Anbieter YouTube. YouTube wird betrieben von
                        YouTube LLC, 901 Cherry Avenue, San Bruno, CA 94066, USA, vertreten durch Google Inc. Wir
                        verwenden ausschließlich den datenschutzfreundlichen Modus von YouTube
                        (youtube-nocookie.com), bei dem YouTube keine Cookies setzt, solange Sie das Video nicht
