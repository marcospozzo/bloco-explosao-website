...
export default function DuoTrioEvents() {
  return (
    <Layout lang="en">
      <section id="main">
                ...
                <div className="row">
                  <div className="col-12">
                    <section className="box">
                      ...
                      <header id="1">
                        <h3>Duo / Trio for events</h3>
                      </header>
                      <p>
                        Bossa Nova, Samba, International: Renato Pantera, singer from Bloco Explosão, comes from the
                        Portela Samba School in Rio de Janeiro. Our duo or trio will also ensure the right atmosphere
                        at your event. Whether concert, wedding, birthday, party, as a Brazil show with Brazilian
                        dancers, a good mood is guaranteed. If desired, the band can be expanded to include additional
                        musicians.
                      </p>
