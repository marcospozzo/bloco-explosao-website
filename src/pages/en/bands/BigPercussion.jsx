...
export default function BigPercussion() {
  return (
    <Layout lang="en">
      <section id="main">
                ...
                <div className="row">
                  <div className="col-12">
                    <section className="box">
                      ...
                      <header id="1">
                        <h3>Big percussion</h3>
                      </header>
                      <p>Depending on your needs, you can book different group sizes.</p>
                      <ul>
                        <li>Up to 20 players.</li>
                        <li>On a stage (street) <a href="#video">(see video below)</a>.</li>
                        <li>As a walking act <a href="#video">(see video below)</a>.</li>
